...
{
    protected $name = 'bargain_category';
    ...
    {
        $model = new static;
        if (!Cache::get('bargain_category_' . $model::$wxapp_id)) {
            ...
            Cache::tag('cache')->set('bargain_category_' . $model::$wxapp_id, compact('all', 'tree'));
        }
        return Cache::get('bargain_category_' . $model::$wxapp_id);
    }
