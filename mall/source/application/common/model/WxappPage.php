...
class WxappPage extends BaseModel
{
    ...
    public function getDefaultPage()
    {
        ...
        return [
            ...
            'style' => [
                ...
                'backgroundUrl' => self::$base_url . 'assets/store/img/diy/phone-top-black.png'
            ]
        ];
    }
    ...
    {
        static $defaultItems = [];
        if (!empty($defaultItems)) return $defaultItems;
        return [
            'search' => [
                'name' => '搜索框',
                'type' => 'search',
    ...
    public function insertDefault($wxapp_id)
    {
        ...
        $data['page_data']= array ( 'page' => array ( 'type' => 'page', 'name' => '页面设置', 'params' => array ( 'name' => '页面名称', 'title' => '页面标题', 'share_title' => '分享标题', ), 'style' => array ( 'titleTextColor' => 'black', 'titleBackgroundColor' => '#ffffff', 'backgroundUrl' => 'https://mp.minstech.cn/addons/mall/web/assets/store/img/diy/phone-top-black.png', ), ), 'items' => array ( 0 => array ( 'name' => '商品组', 'type' => 'goods', 'params' => array ( 'source' => 'auto', 'auto' => array ( 'category' => 0, 'goodsSort' => 'all', 'showNum' => 6, ), ), 'style' => array ( 'background' => '#F6F6F6', 'display' => 'list', 'column' => '2', 'show' => array ( 'goodsName' => '1', 'goodsPrice' => '1', 'linePrice' => '1', ), ), 'defaultData' => array ( 0 => array ( 'goods_name' => '此处显示商品名称', 'image' => 'https://mp.minstech.cn/addons/mall/web/assets/store/img/diy/goods/01.png', 'goods_price' => '99.00', 'line_price' => '139.00', ), 1 => array ( 'goods_name' => '此处显示商品名称', 'image' => 'https://mp.minstech.cn/addons/mall/web/assets/store/img/diy/goods/01.png', 'goods_price' => '99.00', 'line_price' => '139.00', ), 2 => array ( 'goods_name' => '此处显示商品名称', 'image' => 'https://mp.minstech.cn/addons/mall/web/assets/store/img/diy/goods/01.png', 'goods_price' => '99.00', 'line_price' => '139.00', ), 3 => array ( 'goods_name' => '此处显示商品名称', 'image' => 'https://mp.minstech.cn/addons/mall/web/assets/store/img/diy/goods/01.png', 'goods_price' => '99.00', 'line_price' => '139.00', ), ), 'data' => array ( 0 => array ( 'goods_name' => '此处显示商品名称', 'image' => 'https://mp.minstech.cn/addons/mall/web/assets/store/img/diy/goods/01.png', 'goods_price' => '99.00', 'line_price' => '139.00', 'is_default' => true, ), ), ), ), );
        $data['page_type']=10;
    ...
    private function _mergeDefaultData($array)
    {
        ...
        $array['page'] = array_merge_multiple($defaultPage, $array['page']);
