...
{
    protected $name = 'flashsale_category';
    ...
    {
        $model = new static;
        if (!Cache::get('flashsale_category_' . $model::$wxapp_id)) {
            ...
            Cache::tag('cache')->set('flashsale_category_' . $model::$wxapp_id, compact('all', 'tree'));
        }
        return Cache::get('flashsale_category_' . $model::$wxapp_id);
    }
