                    ...
                    <div class="widget-body">
                        <fieldset>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end am-padding-top-xs">
                                    <textarea class="am-field-valid" rows="5" placeholder="请输入评价内容" style="border: 1px solid"
                            ...
                            <div class="am-form-group">
                                <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">是否晒单 </label>
                                <div class="am-u-sm-9 am-u-end">
                                    <label class="am-radio-inline">
                                        <input type="radio" name="comment[is_sun]" value="1" data-am-ucheck
                                            <?= $model['is_sun'] == 1 ? 'checked' : '' ?> >
                                        是
                                    </label>
                                    <label class="am-radio-inline">
                                        <input type="radio" name="comment[is_sun]" value="0" data-am-ucheck
                                            <?= $model['is_sun'] == 0 ? 'checked' : '' ?> >
                                        否
                                    </label>
                                </div>
                            </div>
