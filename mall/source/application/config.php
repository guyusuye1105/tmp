...
return [
    ...
    'database'=>[
        ...
        // 数据库表前缀
        'prefix' => $config['db']['master']['tablepre'].$config['moudle_name']."_",
        // 数据库调试模式
        'debug' => true,
    ...
    'cache'                  => [
        ...
        'type'   => 'redis',
        // 缓存保存目录
        'host'       => $config['setting']['redis']['server'] ,
        'port'       => $config['setting']['redis']['port'] ,
        'password'   => $config['setting']['redis']['auth'] ,
        'select'     => 0,
        'timeout'    => 0,
        'expire'     => 86400,
        'persistent' => false,
        'prefix'     => 'we7addon_'.$config['moudle_name']."_",
    ],
    ...
    'upload'=>[
        ...
        'engine'=>[
            'Aliyun'=>[
                ...
                'oss_path'=>'addons/'.$config['moudle_name']."/uploads",
                'domain_alias'=>$config['oss']['domain_alias']
            ]
        ]
    ],
];
