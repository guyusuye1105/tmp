  ...
  getOrderData: function() {
    ...
    if (options.order_type === 'buyNow') {
      ...
      App._get('order/buyNow', {
        ...
        buyer_remark: options.buyer_remark
      }, function(result) {
        if (result.data.address && result.data.address.extra){
          result.data.address.extra = JSON.parse(result.data.address.extra)
        }
        callback(result);
      });
    }
  ...
  submitOrder: function() {
    ...
    if (options.order_type === 'buyNow') {
      App._post_form('order/buyNow', {
        ...
        remark: this.data.options.buyer_remark ? this.data.options.buyer_remark:_this.data.remark ,
      }, function(result) {
        // success
        console.log('success');
        callback(result);
